...
import org.etux.kafka.deadletter.ApplicationStream
...
fun main() {
    ...
    val deadLetterStream = DeadLetterStream(
        "my-topic",
        "my-state-store",
        properties("localhost:9092")
    )

    val deadLetterPlayer = DeadLetterPlayer(
    ...
    val applicationStream = ApplicationStream(
        inputTopic = "my-topic",
...
fun properties(bootstrapServers: String) = Properties().apply {
